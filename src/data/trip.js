...
export const DAYS = [
  ...
  },
  {
    ...
    see: [
      ...
      "Hyrcyklar: sök bland uthyrare i Bernkastel-Kues och boka gärna kvällen innan – ta med legitimation.",
      "Wehlener Sonnenuhr – den ikoniska solursmarkeringen syns tydligt från cykelbanan; ta gränden ned mot floden för foto.",
      "Ürzig Würzgarten – röd skiffer ger vinerna en unik kryddig karaktär; vingårdsvy direkt från vägen.",
      "Traben-Trarbach: Art Nouveau-arkitektur, Brückentor och ett oväntat Buddha-museum om ni vill stanna längre.",
      "Mosel-kabelferries (Gierseilfähre): handvevade flodöverfarter – kul sidotripp om ni vill byta bank ett tag.",
      "Många vinbönder tar emot för provning direkt vid gården – se listan nedan, boka i förväg för de med appt.",
    ],
    wineries: [
      ...
      { name: "Dr. Pauly-Bergweiler", village: "Bernkastel-Kues", note: "Historisk källare mitt i stan, lättillgängligt även utan bokning.", appt: false, map: gsearch("Weingut Dr. Pauly-Bergweiler Bernkastel-Kues"), web: "https://www.pauly-bergweiler.com/?lang=en" },
      { name: "S.A. Prüm", village: "Wehlen", note: "Vinotek vid floden med utsikt mot Wehlener Sonnenuhr-vingården. Avslappnat drop-in.", appt: false, map: gsearch("Weingut S.A. Prüm Wehlen"), web: "https://sapruem.com/?lang=en" },
      { name: "Selbach-Oster", village: "Zeltingen-Rachtig", note: "Ett av Moselns mest hyllade namn – elegant, precis Riesling. Vinothek vid floden, drop-in möjligt.", appt: false, map: gsearch("Weingut Selbach-Oster Zeltingen"), web: "https://www.selbach-oster.de/" },
      { name: "Schloss Lieser", village: "Lieser", note: "Thomas Haags slottsgård strax norr om Bernkastel. Imponerande läge – bokning rekommenderas starkt.", appt: true, map: gsearch("Weingut Schloss Lieser"), web: "https://www.weingut-schloss-lieser.de/" },
      { name: "Mönchhof / Robert Eymael", village: "Ürzig", note: "Känt för Ürziger Würzgarten på röd skiffer. Vinothek i byn, relativt lättillgängligt.", appt: false, map: gsearch("Weingut Mönchhof Ürzig"), web: "https://www.moenchof.de/" },
      { name: "Markus Molitor", village: "Wehlen/Zeltingen", note: "Butik i Bernkastels gamla stad för provning; bokning krävs för källarvisning ute vid gården.", appt: true, map: gsearch("Weingut Markus Molitor Wehlen"), web: "https://markusmolitor.com/en" },
      { name: "J.J. Prüm", village: "Wehlen", note: "Legendarisk, mycket eftertraktad. Svårast att boka – maila i god tid, räkna med att inte alltid få plats.", appt: true, map: gsearch("Weingut J.J. Prüm Wehlen"), web: "https://www.jjpruem.com/" },
      { name: "Willi Schaefer", village: "Graach", note: "Litet familjeföretag med lysande rykte. Endast bokning, och bara april–juli.", appt: true, map: gsearch("Weingut Willi Schaefer Graach"), web: "https://www.weingut-willi-schaefer.de/en/" },
      { name: "Kerpen", village: "Wehlen", note: "Bokning rekommenderas. Bra för er som föredrar torra/halvtorra stilar snarare än söta.", appt: true, map: gsearch("Weingut Kerpen Wehlen"), web: "https://www.weingut-kerpen.de/" },
    ],
    wineriesMap: gmap(["Bernkastel-Kues, Germany", "Weingut Dr. Loosen Bernkastel-Kues", "Weingut Dr. Pauly-Bergweiler Bernkastel-Kues", "Weingut S.A. Prüm Wehlen", "Weingut Selbach-Oster Zeltingen", "Weingut Schloss Lieser", "Weingut Mönchhof Ürzig", "Weingut J.J. Prüm Wehlen", "Weingut Willi Schaefer Graach", "Bernkastel-Kues, Germany"]),
    plan: [
    ...
    links: [["Moselradweg info", "https://www.mosel.de/en/leisure-sport/cycling/mosel-cycle-path"], ["Hyrcyklar – sök Google", "https://www.google.com/search?q=Fahrradverleih+Bernkastel-Kues"]],
  },
  {
